...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "group/avatar relative flex size-8 shrink-0 rounded-full",
        "select-none after:absolute after:inset-0 after:rounded-full",
...
function AvatarBadge({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      className={cn(
        "absolute right-0 bottom-0 z-10 inline-flex items-center",
        "justify-center rounded-full bg-primary text-primary-foreground",
        "bg-blend-color ring-2 ring-background select-none",
